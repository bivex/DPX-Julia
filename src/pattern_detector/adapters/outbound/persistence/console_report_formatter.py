"""Console Rich Formatter for Julia pattern detection findings."""
...
class ConsoleReportFormatter(ReportFormatterPort):
    ...
    def format(self, report: DetectionReport, verbose: bool = False) -> str:
        ...
        # Header Banner
        header = Panel.fit(
            f"[bold white]🎯 DPX-Julia: Multiple Dispatch, Holy Traits, Metaprogramming & High-Performance Detector (Julia 1.6 - 1.11+)[/bold white]\n"
