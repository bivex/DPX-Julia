"""JSON, Markdown, SARIF formatters & persistence repositories for Julia."""
...
class MarkdownReportFormatter(ReportFormatterPort):
    ...
    def format(self, report: DetectionReport, verbose: bool = False) -> str:
        lines = [
            f"# 🎯 DPX-Julia: Architectural Context & Pattern Report",
            f"",
            ...
            "runs": [
                {
                    "tool": {
                        "driver": {
                            "name": "DPX-Julia",
                            "informationUri": "https://github.com/bivex/DPX-Julia",
                            "version": "0.1.0",
                        }
                    },
                    "results": results,
