"""Detection result and summary aggregates for Julia Pattern Detector."""
...
@dataclass
class Detection:
    """Individual pattern instance or architectural signal identified in Julia source."""

    pattern_type: PatternType
    pattern_category: PatternCategory
    target_name: str
    target_kind: str  # struct, abstract_type, function, macro, module, file
...
class DetectionReport:
    """Aggregate scan report for a Julia codebase."""
