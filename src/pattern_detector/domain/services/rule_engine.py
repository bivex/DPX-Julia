"""Domain service evaluating pattern detection rules on Julia CodeModel."""
...
class RuleEngineService:
    """Evaluates rules against a Julia CodeModel with confidence thresholding and filtering."""
